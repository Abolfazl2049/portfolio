...
export const expert: Tag[] = [
  ...
  {label: "nuxt-i18n", icon: "i-twemoji-globe-with-meridians", to: "https://i18n.nuxt.com", type: "Library"},
  {label: "Trello", icon: "i-logos-trello", to: "https://www.trello.com", type: "Service"}
];

export const proficient: Tag[] = [
  {label: "Vite", icon: "i-logos-vitejs", to: "https://vitejs.dev", type: "Tool"},
  {label: "React", icon: "i-material-icon-theme:react", to: "https://react.dev", type: "Library"},
  {label: "Next", icon: "i-devicon:nextjs", to: "https://nextjs.com", type: "Framework"},
  {label: "Express", icon: "i-skill-icons:expressjs-light", to: "https://expressjs.org", type: "Library"},
  ...
  {label: "ApexChart", icon: "i-devicon:apex", to: "https://apexchart.org", type: "Library"},
...
export const usedBefore: Tag[] = [
  ...
  {label: "Sequelize", icon: "i-logos-sequelize", to: "https://sequelize.org", type: "Library"},
  {label: "AdminJs", icon: "i-vscode-icons:file-type-js-official", to: "https://adminjs.com", type: "Library"},
  {label: "railway", icon: "i-devicon:railway", to: "https://www.railway.com", type: "Service"},
  {label: "Postman", icon: "logos:postman-icon", to: "https://www.postman.com", type: "Tool"},
  {label: "ChartJs", icon: "i-devicon:chartjs", to: "https://chartjs.org", type: "Library"},
  {label: "Flowbite", icon: "i-vscode-icons:file-type-js-official", to: "https://flowbite.org", type: "Library"},
  {label: "Maz ui", icon: "i-vscode-icons:file-type-js-official", to: "https://maz-ui.org", type: "Library"},
  {label: "Render", icon: "i-simple-icons:render", to: "https://www.render.com", type: "Service"},
  {label: "Electron-Vue", icon: "logos:electron", to: "https://www.electronjs.org", type: "Service"}
];
