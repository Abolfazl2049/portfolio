...
export type SkillType = "Language" | "Framework" | "Library" | "Tool" | "Service" | "DevOps" | "Testing" | "Data";

export const SKILL_TYPES: readonly SkillType[] = ["Language", "Framework", "Library", "Tool", "Service", "DevOps", "Testing", "Data"] as const;
