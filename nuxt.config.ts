...
export default defineNuxtConfig({
  ...
  modules: ["@nuxt/content", "@nuxt/fonts", "@nuxt/ui", "@nuxtjs/i18n", "@nuxtjs/color-mode", "@nuxt/image", "@nuxtjs/sitemap"],
  ...
  runtimeConfig: {
    public: {
      ...
      siteName: "AbolfazlShahini",
      siteUrl: "https://abolfazlshahini.vercel.app", // Used for sitemap and RSS generation
