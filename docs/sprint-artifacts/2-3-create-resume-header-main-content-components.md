...
<template>
  <div class="mb-6">
    <h2 class="text-base font-bold text-blue-600 uppercase border-b-2 border-blue-600 pb-1 mb-3">Summary</h2>
...
<template>
  <div class="mb-6">
    <h2 class="text-base font-bold text-blue-600 uppercase border-b-2 border-blue-600 pb-1 mb-4">Work Experience</h2>

    <div
      v-for="job in sortedWork"
      ...
      <ul class="mt-2 text-sm text-gray-800 space-y-1">
        <li
          v-for="(highlight, idx) in job.highlights"
          :key="idx"
          class="flex">
...
- [ ] Header displays name "Abolfazl Shahini" in large bold text
