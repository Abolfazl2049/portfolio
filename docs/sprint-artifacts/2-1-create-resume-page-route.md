...
4. **AC4:** The page title is "Resume - Abolfazl Shahini"
...
- [x] Configure page metadata (AC: #4, #5)
  ...
  - [x] Ensure title format: "Resume - Abolfazl Shahini"
...
- [ ] Browser tab shows "Resume - Abolfazl Shahini"
...
- Added SEO metadata: Title "Resume - Abolfazl Shahini" and `noindex` robot tag.
...
| AC4 | Page title is "Resume - Abolfazl Shahini"  | ✅     | `app/pages/resume.vue:10`    |
